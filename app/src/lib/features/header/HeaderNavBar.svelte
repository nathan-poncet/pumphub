<script lang="ts">
	...
	import type { ActivitiesResponse, CategoriesResponse } from '../../../pocketbase-types';

	export let categories: CategoriesResponse[];
	export let activities: ActivitiesResponse[];
</script>

<div class="flex h-full overflow-hidden rounded-full bg-white p-2">
	<div class="flex-1">
	...
	<div class="mx-2" />
	<button class="btn variant-filled-primary w-12 rounded-full p-2"><MdSearch /></button>
</div>
