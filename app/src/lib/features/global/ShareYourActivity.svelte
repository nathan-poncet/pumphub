		...
		>
			...
			<div class="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
				...
				<p class="mt-6 text-lg leading-8 text-gray-300">
					En rejoignant notre communauté, tu auras la possibilité de présenter ton activité à une
					audience qualifiée, de partager ton savoir-faire et ta passion avec d'autres sportifs, et
					de développer ta clientèle en ligne.
				</p>
